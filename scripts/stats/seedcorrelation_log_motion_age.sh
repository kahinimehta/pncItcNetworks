...
roi1=/data/jux/BBL/projects/pncItcNetworks/subjectData/n269/n269_pearson/logk_motion_scanageYrs/cluster_correct_v001_c05/easythresh/ROI1_2mm_bin.nii.gz
#roi2=/data/jux/BBL/projects/pncItcNetworks/subjectData/n269/n269_pearson/logk_scanageYrs/cluster_correct_v001_c05/easythresh/ROI2_2mm_bin.nii.gz
 mkdir /data/jux/BBL/projects/pncItcNetworks/subjectData/n269/n269_pearson/logk_motion_scanageYrs/cluster_correct_v001_c05/easythresh/ROI1map
 #mkdir /data/jux/BBL/projects/pncItcNetworks/subjectData/n269/n269_pearson/logk_scanageYrs/cluster_correct_v001_c05/easythresh/ROI2map

 outputdir1=/data/jux/BBL/projects/pncItcNetworks/subjectData/n269/n269_pearson/logk_motion_scanageYrs/cluster_correct_v001_c05/easythresh/ROI1map
# outputdir2=/data/jux/BBL/projects/pncItcNetworks/subjectData/n269/n269_pearson/logk_scanageYrs/cluster_correct_v001_c05/easythresh/ROI2map
...
for b  in $scanid;  do 
    ...
    #3dcalc -a  $outputdir2/${b}_ROI1map_r.nii.gz -expr 'atanh(a)' -prefix $outputdir1/${b}_ROI2map_z.nii.gz

    # clear the files not neccessary for next step 
    rm -rf   $outputdir1/ROI1timeseries.1D   $outputdir1/${b}_ROI1map_r.nii.gz  
done
  	
   # group statisttics 
   groupmapdir=/data/jux/BBL/projects/pncItcNetworks/subjectData/n269/n269_pearson/logk_motion_scanageYrs/cluster_correct_v001_c05
