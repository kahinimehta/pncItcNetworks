...
#scanids 
datadir=$(ls -d  /data/jux/BBL/projects/pncItcNetworks/subjectData) # subject datadir on chead 
...
outputdir=/data/jux/BBL/projects/pncItcNetworks/subjectData/rest4mm  # moved to cbica: 
outputdir2=/data/jux/BBL/projects/pncItcNetworks/subjectData/rest # move to cbica: 
mkdir -p $outputdir
mkdir -p $outputdir2
...
do 
     ...
     echo "$imagelist" >>  $datadir/imageinput_rest.txt  #input list  for cwasmdmr 
